class MenuPrincipalNivel9 extends Phaser.Scene {
  constructor() {
    super({ key: "MenuPrincipalNivel9", active: true });
  ...
  cambiarEscena() {
    ...
    this.scene.start("IntroduccionNivel9");
  }
...
window.MenuPrincipalNivel9 = MenuPrincipalNivel9;
